...
export default function TypeAheadActors(props: typeAheadActorsProps) {
  ...
  const actors: actorMovieDTO[] = [
        ...
        { id: 2, name: 'Fernando', character: '', picture: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Dwayne_Johnson_2014_%28cropped%29.jpg/220px-Dwayne_Johnson_2014_%28cropped%29.jpg' },
        { id: 3, name: 'Jessica', character: '', picture: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Dwayne_Johnson_2014_%28cropped%29.jpg/220px-Dwayne_Johnson_2014_%28cropped%29.jpg' },
    ]
    ...
    return (
        <div className="mb-3">
            ...
            <Typeahead
                ...
                flip={true}
                selected={selected}
                renderMenuItemChildren={(a: any) => (
                    <>
                        <img
                            alt="actor" src={a.picture}
                            style={{
                                height: '64px',
                                marginRight: '10px',
                                width:'64px'
