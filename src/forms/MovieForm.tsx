    ...
    return (
        <Formik
            ...
            onSubmit={(values,actions)=>{
                values.genresIds=selectedGenres.map((item:any)=>item.key);
                values.movieTheatersIds=selectedMovieTheaters.map((item:any)=>item.key);
            ...
            {formikProps => (
                <Form>
                    <TextField displayName="Title" feild="title" />
                    <CheckboxField displayName="In Theatres" field="inTheaters" />
                    <TextField displayName="Trailer" feild="trailer" />
